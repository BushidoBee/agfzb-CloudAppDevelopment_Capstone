function main(params) {
    return new Promise(function (resolve, reject) {
      ...
      // Insert a review, and attach to unique ID
      doc = params.review;
  ...
  let result = main({
    json: {
      time: "2022-08-10T14:12:12.927873",name: "Friend 1",
      dealership: 3, review: "This is just another review from another person. Good enough.",
      purchase: false, purchase_date: "",
      car_make: "Volvo", car_model: "V60 Recharge", car_year: "2022",
    },
  });
